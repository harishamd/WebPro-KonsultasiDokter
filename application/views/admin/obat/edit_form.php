						...
						<form action="<?php base_url(" obats/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama_obat') ? 'is-invalid':'' ?>"
								 type="text" name="nama_obat" placeholder="Nama Obat" value="<?php echo $obat->nama_obat ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>"
								 type="number" name="harga" min="0" placeholder="Harga Obat" value="<?php echo $obat->harga ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input type="hidden" name="old_image" value="<?php echo $obat->gambar ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('deskripsi') ? 'is-invalid':'' ?>"
								 name="deskripsi" placeholder="Deskripsi Obat..."><?php echo $obat->deskripsi ?></textarea>
								<div class="invalid-feedback">
